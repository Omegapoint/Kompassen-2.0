  ...
  (
    ...
    >
      <Typography variant="h6">
        OPKoKo är Omegapoints kompetenskonferens som går av stapeln två gånger per år. Den samlar
        och engagerar hela företaget. Under flera dagar delar vi med oss av kunskap och erfarenheter
        i föreläsningar, labbar och workshops. OPKoKo är också ett sätt för oss att lära känna
        varandra ännu bättre. <br />
        <br />
      ...
      <Typography variant="body1">
        ...
        <br />
        För praktiska- och resetekniska frågor, ta gärna kontakt med: Anders Wiström & Amanda
        Hörnell hos vår eventpartner Eventyr Nine Yards,{' '}
